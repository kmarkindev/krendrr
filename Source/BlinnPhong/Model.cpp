...
void krendrr::render::Model::Load(const std::string_view& ModelFileName, const LoadParams& Params)
{
...
std::span<const krendrr::render::Model::TexturedMesh> krendrr::render::Model::GetMeshes() const
{
    return Meshes;
}
